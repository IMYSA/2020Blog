<template>
    <div>
        ...
        <div>
            <el-button   style="width: 10%;margin-left: 1200px" @click="add_favorite" v-show="!isFavorite" :key="favorite1">收藏</el-button>
            <el-button   style="width: 10%;margin-left: 1200px" @click="cancel_favorite" v-show="isFavorite" :key="favorite2">取消收藏</el-button>
        </div>
        ...
        <el-button style="width: 10%;margin-left: 460px;margin-top: 30px">发表</el-button>
    </div>
</template>
        ...
        mounted(){
            this.$axios
                ...
                .then(successResponse => {
                    ...
                    this.author_id = successResponse.data.description
                })
             .catch(failResponse => {
